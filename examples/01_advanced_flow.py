#!/usr/bin/env python3
"""Run an advanced browser task and print summary fields."""
...
def wait_for_terminal_status(
    base_url: str, task_id: str, interval: float, timeout_s: int
):
    started = time.time()
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run an advanced Browser Use bridge flow"
    )
    parser.add_argument(
